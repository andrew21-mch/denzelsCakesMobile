...
class _CakeDetailScreenState extends ConsumerState<CakeDetailScreen> {
  ...
  // Delivery and customization controllers
  ...
  Future<void> _addToCart() async {
    ...
    try {
      ...
      if (_selectedDeliveryDate != null) {
        customizations['deliveryDate'] = _selectedDeliveryDate!.toIso8601String();
      }
      
      if (_selectedDeliveryTime != null) {
        customizations['deliveryTime'] = '${_selectedDeliveryTime!.hour.toString().padLeft(2, '0')}:${_selectedDeliveryTime!.minute.toString().padLeft(2, '0')}';
      }
      
      if (_customizationController.text.isNotEmpty) {
        customizations['specialInstructions'] = _customizationController.text;
      }
...
// print('DEBUG: Error adding to cart: $e');
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tell us how you\'d like your cake customized (colors, message, decorations, etc.)',
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildCustomizationOption('Custom Message'),
              _buildCustomizationOption('Color Theme'),
              _buildCustomizationOption('Special Decorations'),
              _buildCustomizationOption('Dietary Requirements'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildCustomizationOption(String option) {
    return Container(
